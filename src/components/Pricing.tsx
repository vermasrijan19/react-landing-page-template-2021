      ...
      <div className={`container mx-auto px-2 pt-4 pb-12 text-primary`}>
        ...
        >
          ...
          >
            ...
            <div
              className={`flex-none mt-0 bg-background rounded-b rounded-t-none overflow-hidden shadow p-6`}
            >
              <div
                className={`w-full pt-0 text-3xl text-gray-600 font-bold text-center`}
              >
                {firstPlan?.price}
          ...
          <div
            className={`transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110  duration-300 flex flex-col w-5/6 lg:w-1/3 mx-auto lg:mx-0 rounded-lg bg-background mt-4 sm:-mt-6 shadow-lg z-10`}
          >
            <div
            ...
            <div
              className={`flex-none mt-0 bg-background rounded-b rounded-t-none overflow-hidden shadow p-6`}
            >
              <div className={`w-full pt-0 text-4xl font-bold text-center`}>
                {secondPlan?.price}
